...
| Gray/200     | --color-gray-200     | #f3f4f6 |
...
| background/Subtle          | --color-background-subtle            | #fafafa (primitive 매칭 없음)    | 옅은 배경          |
...
| Background/Neutral/Default | --color-background-neutral-default   | #5a5a5a (primitive 매칭 없음)    | 중립 배경          |
